...
- x264 commit `b35605ace3ddf7c1a5d67a2eb553f034aef41d55`: `https://code.videolan.org/videolan/x264/-/archive/b35605ace3ddf7c1a5d67a2eb553f034aef41d55/x264-b35605ace3ddf7c1a5d67a2eb553f034aef41d55.tar.gz`
...
The Tauri app declares `tauri`, `tauri-build`, `tauri-plugin-shell`, `serde_json`, and target-conditional `libc` (on Unix targets) dependencies from crates.io. The resolved crate metadata (458 total Cargo dependencies in the current lockfile) is open-source, primarily MIT, Apache-2.0, BSD, Unicode-3.0, MPL-2.0, Zlib, and compatible dual-license expressions. Check the resolved `src-tauri/Cargo.lock` and crate metadata before release packaging.
